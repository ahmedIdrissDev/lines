...
const Access = () => {
  return (
    <div className='flex z-30 fixed bg-neutral-950/5  justify-center items-center inset-0'>
         ...
         <div className="w-94 p-2  text-center gap-2 h-max py-5 flex-col flex justify-center items-center bg-white rounded-2xl">
...
<h1>Access to Tgcc My Team is denied for this account</h1>
<button className='w-full h-12 bg-tgcc-700 text-white rounded-2xl'>Tgcc It</button>
</div>
    </div>
  )
}
