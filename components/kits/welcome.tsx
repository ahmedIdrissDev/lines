...
<div className="text-center">
      <h1 className='text-2xl'>Welcome I <span className='w-max px-3 border bg-linear-60 text-transparent bg-clip-text from-tgcc-700 to-tgcc-300 border-neutral-200 rounded-full'> Tgcc Atlas </span> based on Google Geming</h1>
