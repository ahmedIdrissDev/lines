...
const AddEmployees = () => {
  ...
  async  function handleFormSubmit(e:FormEvent<HTMLFormElement>){
               try {
                    ...
                    result ? toast.success('Merci beaucoup !') : toast.error('Le matricule de l’employé existe déjà')
  ...
  return (
    <div className='flex justify-center items-center h-dvh' >
          <form ref={formRef} onSubmit={handleFormSubmit} className="w-1/2  flex flex-col gap-2 h-max p-2 bg-white rounded-2xl">
              <div className="">
               <h1 className='text-2xl'>Ajouter un employé</h1>
               <p>Créez et gérez les profils des employés en les ajoutant au système.</p>
              </div>
