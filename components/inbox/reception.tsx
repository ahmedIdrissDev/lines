  ...
  return (
    <div className="flex py-1.5 flex-col ">
      ...
      {emails.map(({subject ,_id ,_creationTime})=>{
        ...
        return(
          <Link href={`/workspace/${_id}`} key={_id} className="w-full relative hover:bg-neutral-50 duration-150 px-2 border-b cursor-pointer flex-col items-start border-neutral-100 nim-h-10 flex ">
