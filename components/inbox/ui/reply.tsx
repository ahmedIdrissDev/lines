...
const ReplyButton = ({text}:{text?:string}) => {
  ...
  return (
    <div onClick={handleAIdatawriting} className='w-max px-2 text-tgcc-950 group cursor-pointer rounded-full h-10 flex  justify-center items-center gap-1.5 bg-tgcc-100   border-neutral-200  '>
