...
<div className="flex justify-center items-center">
   <Image src={'/icon.png'} width={1000} height={1000} className="w-20" alt="logo" />
      ...
      <div className="text-center">
        ...
        <button onClick={()=> signIn('google')} className="w-full flex justify-center items-center h-12 border border-neutral-200     rounded-2xl cursor-pointer">continue avec google</button>
     </div>
   </div>
