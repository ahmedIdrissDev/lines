...
const page = () => {
  return (
    ...
    <div className='grid grid-cols-4 gap-2'>
        <Link href={'/rapport-general/presonnel'} className="w-full flex-col gap-1.5 border-t-[10px]  bg-white hover:border-primary group duration-150 border border-neutral-200 flex rounded-md justify-center items-center h-70">
      ...
      <Link href={'/rapport-general/transport'} className="w-full flex-col gap-1.5 border-t-[10px]  bg-white hover:border-primary group duration-150  border border-neutral-200 flex rounded-md justify-center items-center h-70">
