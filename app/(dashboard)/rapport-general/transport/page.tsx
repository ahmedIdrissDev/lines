                ...
                return (
                  <tr key={row.busId} className="hover:bg-slate-50 group">
                    <td className="sticky left-0 z-10 bg-white border-b border-r px-4 py-3 font-medium text-slate-700 group-hover:bg-slate-50 transition-colors">
                      <div className="flex flex-col">
                        <span className="uppercase font-bold">{row.matricule}</span>
                    ...
                    <td className="sticky right-0 z-10 bg-white border-b border-l text-center font-semibold text-slate-900 group-hover:bg-slate-50 transition-colors shadow-[-4px_0_8_rgba(0,0,0,0.02)]">
                      {rowTotal}
                    </td>
                  </tr>
                )
