  ...
  if (!projectId) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-ash">
        ...
        <p className="text-sm">Veuillez sélectionner un projet pour voir les sous-traitants.</p>
      </div>
    )
  }
  ...
  return (
    <div className='p-8 max-w-7xl mx-auto'>
      <div className="mb-12">
        ...
        <p className="body-sm text-ash mt-2">Liste des sous-traitants pour le projet sélectionné</p>
      </div>
      ...
      {subcontractors === undefined ? (
        ...
        subcontractors.length === 0 ? (
          <div className="flex flex-col items-center justify-center min-h-[300px] bg-white rounded-md border border-hairline border-dashed">
            ...
            <p className="body-sm text-ash mt-4">Aucun sous-traitant trouvé pour ce projet.</p>
          </div>
        ) : (
        ...
        <div className="flex flex-col items-center justify-center min-h-[300px] bg-white rounded-2xl border border-hairline border-dashed px-6 text-center">
           ...
           <p className="text-ash text-sm">
             {typeof subcontractors === 'object' && subcontractors !== null && 'error' in subcontractors 
